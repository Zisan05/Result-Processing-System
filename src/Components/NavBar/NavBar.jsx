...
const NavBar = () => {
    return (
        <div className="background py-[20px] flex flex-row md:flex-row justify-between border-b-4">
            ...
            <h1 className="text-[18px] md:text-[35px] text-purple bg-gradient-to-r from-white to-[#6164FF] text-transparent bg-clip-text md:pl-[20px] font-bold"><span className="">Result</span> Processing System</h1>
